...
class UsersList extends Component{
    ...
    fetchUsers = () => {
        fetch('http://thirsty-poincare-06aed9.netlify.com/php-react/all-users.php')
        .then(response => {
    ...
    handleUpdate = (id) => {
        Axios.post('http://thirsty-poincare-06aed9.netlify.com/php-react/update-user.php',
        {
            id:id,
    ...
    handleDelete = (id) => {
        ...
        Axios.post('http://thirsty-poincare-06aed9.netlify.com/php-react/delete-user.php',{
            id:id
        })
        .then(({data}) => {
            if(data.success === 1){
